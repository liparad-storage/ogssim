...
/**
 * @file	layoutraidnp_write_nodecl.cpp
 * @brief	Functions for write requests for RAID-NP without parity
 * declustering.
 */
...
void
LayoutRAIDNP::__WRITE_NODEC_SREQOPT (
