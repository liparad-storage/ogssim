...
/**
 * @file	layoutraidnp_write_dtdecl.cpp
 * @brief	Functions for write requests for RAID-NP with data declustering.
 */

#include "LayoutModels/layoutraidnp.hpp"

void
LayoutRAIDNP::__WRITE_DATADEC_SREQOPT (
	...
	std::vector < OGSS_Ulong >	& subrequests)
{
	...
	__APPLY_DATADEC (tmp_b);
	__APPLY_DATADEC (tmp_c);
	__APPLY_DATADEC (tmp_d);
