...
/**
 * @file	graphgenfullreqpercentile.hpp
 * @brief	Graph generation mechanism: request percentile (with all request
 * times).
 */

#ifndef __OGSS_GRAPHGENFULLREQPERCENTILE_HPP__
#define __OGSS_GRAPHGENFULLREQPERCENTILE_HPP__

#include "GraphGeneration/graphgeneration.hpp"

class GraphGenFullReqPercentile: public GraphGeneration {
public:
/**************************************/
/* PUBLIC FUNCTIONS *******************/
/**************************************/
