...
/**
 * @file	graphgendevbehavior.hpp
 * @brief	Graph generation mechanism: device behavior (utilization rate).
 */

#ifndef __OGSS_GRAPHGENDEVBEHAVIOR_HPP__
#define __OGSS_GRAPHGENDEVBEHAVIOR_HPP__

#include "GraphGeneration/graphgeneration.hpp"

#include "Structures/types.hpp"

class GraphGenDevBehavior: public GraphGeneration {
public:
/**************************************/
/* PUBLIC FUNCTIONS *******************/
/**************************************/
 ...
 * @param	idxVolume			Targeted volume index.
 */
	GraphGenDevBehavior (
...
/* ATTRIBUTES *************************/
/**************************************/
	OGSS_Ushort					m_idxVolume;			/*!< Targeted volume
															 index. */
};
